  ...
  return hyperliquidPositions
    .map((hlPos: any) => {
      ...
      return {
        ...
        exitMode: dbPos?.exitMode,
        managedPeakPrice: dbPos?.managedPeakPrice,
        managedStopPrice: dbPos?.managedStopPrice,
        managedStopReason: dbPos?.managedStopReason,
        breakEvenActivatedAt: dbPos?.breakEvenActivatedAt,
        trailingActivatedAt: dbPos?.trailingActivatedAt,
        trailingTightenedAt: dbPos?.trailingTightenedAt,
        exitRulesSnapshot: dbPos?.exitRulesSnapshot,
